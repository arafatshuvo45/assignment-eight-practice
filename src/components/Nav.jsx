...
if(e.target.checked){
  ...
  <div className="flex-1">
    <a className="btn btn-ghost gap-0 text-2xl">Byte <span className="text-primary">blase</span> </a>
  </div>
  <div className="flex-none">
    ...
    <Link to='/bookmarks'  className="font-bold text-primary">Bookmarks</Link>
